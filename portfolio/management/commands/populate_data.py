...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create sample projects - Note: image field is required, using placeholder
        projects_data = [
            {
                ...
                'featured': True,
                # 'image': 'image/upload/v1234567890/placeholder.jpg',  # Placeholder Cloudinary URL
            },
            {
                ...
                'featured': True,
                # 'image': 'image/upload/v1234567890/placeholder.jpg',
            },
            {
        ...
        self.stdout.write(
            self.style.SUCCESS(f"\nSample data created successfully! Created {Skill.objects.count()} skills and {Project.objects.count()} projects")
        )
